...
extension Buff {
    static let allBuffs: [Buff] = [
        ...
        // ── 新增 10 种 Buff ──
        Buff(name: L10n.localized("成双成对", en: "Twin Strike", ja: "ツインストライク", ko: "쌍쌍이", fr: "Double Frappe", de: "Doppelschlag", es: "Golpe Doble", pt: "Golpe Duplo"),
             description: L10n.localized("对子额外+40基础分", en: "Pairs +40 chips", ja: "ペア+40チップ", ko: "페어 +40 칩", fr: "Paires +40 jetons", de: "Paare +40 Chips", es: "Pares +40 fichas", pt: "Pares +40 fichas"),
             type: .pairBonus, value: 40, icon: "👯"),
        Buff(name: L10n.localized("三生有幸", en: "Triple Fortune", ja: "三位一体", ko: "삼생유행", fr: "Triple Fortune", de: "Dreifachglück", es: "Triple Fortuna", pt: "Tripla Fortuna"),
             description: L10n.localized("三条类牌型×1.8倍率", en: "Triples ×1.8 mult", ja: "トリプル×1.8倍率", ko: "트리플 ×1.8 배율", fr: "Triples ×1.8 mult", de: "Drillinge ×1.8 Mult", es: "Triples ×1.8 mult", pt: "Trincas ×1.8 mult"),
             type: .tripleBonus, value: 1.8, icon: "🎲"),
        Buff(name: L10n.localized("连击狂潮", en: "Combo Surge", ja: "連撃の嵐", ko: "연타 광풍", fr: "Vague Combo", de: "Kombosturm", es: "Oleada Combo", pt: "Surto Combo"),
             description: L10n.localized("连击时额外+0.3倍率", en: "+0.3 mult per combo", ja: "コンボ毎+0.3倍率", ko: "콤보당 +0.3 배율", fr: "+0.3 mult par combo", de: "+0.3 Mult pro Kombo", es: "+0.3 mult por combo", pt: "+0.3 mult por combo"),
             type: .comboMultiplier, value: 1.3, icon: "⚡"),
        Buff(name: L10n.localized("独狼之力", en: "Lone Wolf", ja: "一匹狼", ko: "독랑의 힘", fr: "Loup Solitaire", de: "Einsamer Wolf", es: "Lobo Solitario", pt: "Lobo Solitário"),
             description: L10n.localized("单张出牌+25基础分", en: "Single cards +25 chips", ja: "単騎+25チップ", ko: "단장 +25 칩", fr: "Cartes seules +25 jetons", de: "Einzelkarten +25 Chips", es: "Cartas sueltas +25 fichas", pt: "Cartas solo +25 fichas"),
             type: .singleBonus, value: 25, icon: "🐺"),
        Buff(name: L10n.localized("连锁反应", en: "Chain Link", ja: "連鎖反応", ko: "연쇄 반응", fr: "Réaction en Chaîne", de: "Kettenreaktion", es: "Reacción en Cadena", pt: "Reação em Cadeia"),
             description: L10n.localized("连对牌型×2.0倍率", en: "Pair straights ×2.0 mult", ja: "連対×2.0倍率", ko: "연대 ×2.0 배율", fr: "Suites paires ×2.0 mult", de: "Paarstraßen ×2.0 Mult", es: "Escaleras pares ×2.0 mult", pt: "Sequências pares ×2.0 mult"),
             type: .pairStraightBonus, value: 2.0, icon: "🔗"),
        Buff(name: L10n.localized("四方碾压", en: "Quad Crusher", ja: "四方粉砕", ko: "사방 압살", fr: "Écrasement Quadra", de: "Vierfach-Brecher", es: "Aplasta Cuatro", pt: "Esmaga Quatro"),
             description: L10n.localized("四带二+80基础分", en: "Four-with-two +80 chips", ja: "四帯二+80チップ", ko: "사대이 +80 칩", fr: "Quatre-avec-deux +80 jetons", de: "Vier-mit-zwei +80 Chips", es: "Cuatro-con-dos +80 fichas", pt: "Quatro-com-dois +80 fichas"),
             type: .fourWithTwoBonus, value: 80, icon: "💎"),
        Buff(name: L10n.localized("铁打根基", en: "Iron Foundation", ja: "鉄の基盤", ko: "철의 기반", fr: "Fondation de Fer", de: "Eisenfundament", es: "Cimiento de Hierro", pt: "Fundação de Ferro"),
             description: L10n.localized("所有出牌+15基础分", en: "+15 chips to all plays", ja: "全出牌+15チップ", ko: "모든 출패 +15 칩", fr: "+15 jetons à tous les jeux", de: "+15 Chips auf alle Züge", es: "+15 fichas a todas las jugadas", pt: "+15 fichas em todas as jogadas"),
             type: .chipFlat, value: 15, icon: "🪨"),
        Buff(name: L10n.localized("灵气加持", en: "Spirit Boost", ja: "霊気増幅", ko: "영기 가호", fr: "Élan Spirituel", de: "Geistschub", es: "Impulso Espiritual", pt: "Impulso Espiritual"),
             description: L10n.localized("所有出牌+0.5倍率", en: "+0.5 mult to all plays", ja: "全出牌+0.5倍率", ko: "모든 출패 +0.5 배율", fr: "+0.5 mult à tous les jeux", de: "+0.5 Mult auf alle Züge", es: "+0.5 mult a todas las jugadas", pt: "+0.5 mult em todas as jogadas"),
             type: .multFlat, value: 0.5, icon: "💫"),
        Buff(name: L10n.localized("皇恩浩荡", en: "Royal Favor", ja: "皇恩浩蕩", ko: "황은호탕", fr: "Faveur Royale", de: "Königsgunst", es: "Favor Real", pt: "Favor Real"),
             description: L10n.localized("A/2/K牌+20基础分", en: "A/2/K cards +20 chips", ja: "A/2/Kカード+20チップ", ko: "A/2/K 카드 +20 칩", fr: "Cartes A/2/K +20 jetons", de: "A/2/K-Karten +20 Chips", es: "Cartas A/2/K +20 fichas", pt: "Cartas A/2/K +20 fichas"),
             type: .highCardChip, value: 20, icon: "👑"),
        Buff(name: L10n.localized("草根之力", en: "Grassroot Power", ja: "草の根の力", ko: "풀뿌리의 힘", fr: "Force Populaire", de: "Graswurzelkraft", es: "Fuerza Popular", pt: "Força Popular"),
             description: L10n.localized("3-6点牌+15基础分", en: "3-6 cards +15 chips", ja: "3-6カード+15チップ", ko: "3-6 카드 +15 칩", fr: "Cartes 3-6 +15 jetons", de: "3-6 Karten +15 Chips", es: "Cartas 3-6 +15 fichas", pt: "Cartas 3-6 +15 fichas"),
             type: .lowCardChip, value: 15, icon: "🌱"),
        // ── 第三批 10 种 Buff — 高级限时效果 ──
        Buff(name: L10n.localized("灼热之手", en: "Burning Hand", ja: "灼熱の手", ko: "작열의 손", fr: "Main Brûlante", de: "Brennende Hand", es: "Mano Ardiente", pt: "Mão Ardente"),
             description: L10n.localized("每次出牌+20基础分", en: "+20 chips per play", ja: "出牌毎+20チップ", ko: "출패마다 +20 칩", fr: "+20 jetons par jeu", de: "+20 Chips pro Zug", es: "+20 fichas por jugada", pt: "+20 fichas por jogada"),
             type: .burnHand, value: 20, icon: "🔥"),
        Buff(name: L10n.localized("冰封之心", en: "Frozen Heart", ja: "氷封の心", ko: "빙봉의 심장", fr: "Cœur Glacé", de: "Eisiges Herz", es: "Corazón Helado", pt: "Coração Gelado"),
             description: L10n.localized("弃牌不打断连击", en: "Discards don't break combo", ja: "捨牌でコンボ途切れず", ko: "버림패 콤보 유지", fr: "Défausses sans briser combo", de: "Abwerfen unterbricht Kombo nicht", es: "Descartes no rompen combo", pt: "Descartes não quebram combo"),
             type: .iceFrozen, value: 0, icon: "❄️"),
        Buff(name: L10n.localized("鹰眼", en: "Eagle Eye", ja: "鷹の目", ko: "매의 눈", fr: "Œil d'Aigle", de: "Adlerauge", es: "Ojo de Águila", pt: "Olho de Águia"),
             description: L10n.localized("可查看牌堆顶3张", en: "See next 3 draw pile cards", ja: "山札上位3枚を確認", ko: "덱 상위 3장 확인", fr: "Voir 3 cartes suivantes", de: "Nächste 3 Karten sehen", es: "Ver 3 cartas siguientes", pt: "Ver 3 cartas seguintes"),
             type: .eagleEye, value: 0, icon: "🦅"),
        Buff(name: L10n.localized("点石成金", en: "Alchemy Stone", ja: "錬金石", ko: "연금석", fr: "Pierre Alchimique", de: "Alchemiestein", es: "Piedra Alquímica", pt: "Pedra Alquímica"),
             description: L10n.localized("2和3的chips等同于A", en: "2 and 3 chips equal to A", ja: "2と3のチップがAと同等", ko: "2와 3의 칩이 A와 동일", fr: "Jetons des 2 et 3 égaux à A", de: "2 und 3 Chips gleich A", es: "Fichas de 2 y 3 iguales a A", pt: "Fichas de 2 e 3 iguais a A"),
             type: .alchemyStone, value: 0, icon: "⚗️"),
        Buff(name: L10n.localized("乾坤一掷", en: "All-In Bomb", ja: "乾坤一擲", ko: "건곤일척", fr: "Bombe Totale", de: "Alles-oder-Nichts", es: "Bomba Total", pt: "Bomba Total"),
             description: L10n.localized("下一次炸弹×3倍率", en: "Next bomb ×3 mult", ja: "次の爆弾×3倍率", ko: "다음 폭탄 ×3 배율", fr: "Prochaine bombe ×3 mult", de: "Nächste Bombe ×3 Mult", es: "Próxima bomba ×3 mult", pt: "Próxima bomba ×3 mult"),
             type: .allInBomb, value: 3.0, icon: "🎰"),
        Buff(name: L10n.localized("顺风顺水", en: "Smooth Sailing", ja: "順風満帆", ko: "순풍순수", fr: "Vent Favorable", de: "Guter Wind", es: "Viento a Favor", pt: "Vento a Favor"),
             description: L10n.localized("下一次顺子chips×2", en: "Next straight ×2 chips", ja: "次のストレート チップ×2", ko: "다음 스트레이트 칩 ×2", fr: "Prochaine suite ×2 jetons", de: "Nächste Straße ×2 Chips", es: "Próxima escalera ×2 fichas", pt: "Próxima sequência ×2 fichas"),
             type: .windStraight, value: 2.0, icon: "🌊"),
        Buff(name: L10n.localized("飞黄腾达", en: "Soaring Fortune", ja: "飛黄騰達", ko: "비황등달", fr: "Fortune Ascendante", de: "Aufstieg", es: "Fortuna Ascendente", pt: "Fortuna Ascendente"),
             description: L10n.localized("飞机牌型+100基础分", en: "Planes +100 chips", ja: "飛行機+100チップ", ko: "비행기 +100 칩", fr: "Avions +100 jetons", de: "Flugzeuge +100 Chips", es: "Aviones +100 fichas", pt: "Aviões +100 fichas"),
             type: .planeAscend, value: 100, icon: "🏅"),
        Buff(name: L10n.localized("天降横财", en: "Gold Windfall", ja: "天来の富", ko: "횡재", fr: "Aubaine Dorée", de: "Goldsegen", es: "Lluvia de Oro", pt: "Chuva de Ouro"),
             description: L10n.localized("过关金币+50%", en: "+50% floor clear gold", ja: "フロアクリア金貨+50%", ko: "층 클리어 골드 +50%", fr: "+50% or de passage", de: "+50% Gold bei Abschluss", es: "+50% oro al pasar piso", pt: "+50% ouro ao limpar andar"),
             type: .goldWindfall, value: 1.5, icon: "🤑"),
        Buff(name: L10n.localized("破釜沉舟", en: "Desperate Strike", ja: "背水の陣", ko: "파부침주", fr: "Frappe Désespérée", de: "Verzweiflungsschlag", es: "Golpe Desesperado", pt: "Golpe Desesperado"),
             description: L10n.localized("出牌次数-2但+3.0倍率", en: "Plays -2, but +3.0 mult", ja: "出牌回数-2、倍率+3.0", ko: "출패 -2, 배율 +3.0", fr: "Jeux -2, mais +3.0 mult", de: "Züge -2, aber +3.0 Mult", es: "Jugadas -2, pero +3.0 mult", pt: "Jogadas -2, mas +3.0 mult"),
             type: .desperateStrike, value: 3.0, icon: "⚔️"),
        Buff(name: L10n.localized("洗牌大师", en: "Shuffle Master", ja: "洗牌の達人", ko: "셔플 마스터", fr: "Maître du Mélange", de: "Mischmeister", es: "Maestro Barajador", pt: "Mestre da Embaralhada"),
             description: L10n.localized("每层可重新发牌1次", en: "Redeal hand once per floor", ja: "各フロアで1回手札配り直し", ko: "층당 1회 재배분", fr: "Redistribuer 1 fois par étage", de: "Hand 1× pro Etage neu geben", es: "Repartir 1 vez por piso", pt: "Redistribuir 1 vez por andar"),
